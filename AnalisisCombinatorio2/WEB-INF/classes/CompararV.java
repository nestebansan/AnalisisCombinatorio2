...
public class CompararV extends HttpServlet{
    public void doGet(HttpServletRequest request, HttpServletResponse response){
        ...
        //public void devolverPaginaHTML(HttpServletResponse response){
            ...
            out.println("<p align='center'><font size='2'><b>Tipo de Variaci&oacute;n: " +variacion+"</b></font></p>");
            if (variacion.equals("V")==true){
                out.println("<form method='GET' action='V'>");
            } else {
                out.println("<form method='GET' action='VR'>");
            }
            out.println("<BR>");
